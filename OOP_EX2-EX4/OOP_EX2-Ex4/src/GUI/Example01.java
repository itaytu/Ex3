...
public class Example01 extends JFrame {
	...
	/**
	 * Our Example01 constructor sets the frame's size, adds the visual components,
	 * and then makes them visible to the user. It uses an adapter class to deal
	 * with the user closing the frame.
	 **/
	public Example01() {
		// Title our frame.
