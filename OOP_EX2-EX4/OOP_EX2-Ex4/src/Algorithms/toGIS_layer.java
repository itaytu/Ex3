...
/**
 * This class represents an implementation of the GIS_layer interface. In this
 * class we create a toGIS_layer holding a Set of GIS_element. The class has
...
public class toGIS_layer implements GIS_layer {
	...
	/**
	 * This function creates the Meta_data associated with the GIS_layer. The
