...
/**
 * This class represents an implementation of the GIS_project interface. In this
 * class we create a toGIS_project holding a Set of GIS_layer. The class has
 * functions implemented from the Set class and other functions implemented from
 * GIS_project
 * 
 * Some of the functions are: size, add, remove, isEmpty, Iterator,
 * get_meta_data etc.
 * 
...
public class toGIS_project implements GIS_project {
	...
	/**
	 * This function creates the Meta_data associated with the GIS_project. The
	 * Meta_data contains: UTC, Orientation, toString
	 * 
	 * @return Meta_data
	 */
	@Override
