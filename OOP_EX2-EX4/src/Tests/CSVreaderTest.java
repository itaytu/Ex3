...
class CSVreaderTest {
	String[] firstElementExpected = {"40:65:a3:35:4c:c4", "Efrat", "[WPA-PSK-CCMP+TKIP][WPA2-PSK-CCMP+TKIP][ESS]", 
			"2017-12-01 10:49:08", "1", "-75", "32.17218268216534", "34.81446401702757", "13.65040888895076",
			  "6", "WIFI" };
	ArrayList<String[]> myDataString = CSVreader.reader("C:/Test/WigleWifi_20171201110209.csv");
